...
# Respons nyata pod GPU 2026-06-04 (Surat Tugas: hal di-null-kan guard + warning-nya).
_EX_FINISHED = {
    ...
    "result": {
        ...
        "docling_elapsed_s": 1.088, "metadata_elapsed_s": 4.326, "ringkasan_elapsed_s": 1.483,
